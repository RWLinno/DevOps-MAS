...
from agents.core_agents import RouteAgent
from adapter.privacy_adapter import PrivacyAdapter
from tools.db_tool import DatabaseTools
from tools.log_tool import LogTools

# 配置日志
logging.basicConfig(level=logging.INFO)
logger = logging.getLogger("devops_mas.mcp")
...
class MCPServer:
    def __init__(self):
        self.app = FastAPI(title="DevOps-MAS MCP Server")
